...
for i in range(1, ultima_pagina+1):
    ...
    soup = BeautifulSoup(site.content, 'html.parser')
    produtos = soup.find_all('div', class_=re.compile('list-product'))

    for produto in produtos:
        marca = produto.find('span', class_=re.compile('MuiTypography-h6')).get_text().strip()
...
# df.to_csv('C:/Users/gui_l/3D Objects/preco_cadeira.csv', encoding='utf-8', sep=';')
